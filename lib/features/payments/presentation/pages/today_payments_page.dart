    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: payment.statusColor.withValues(alpha: isDark ? 0.18 : 0.08),
            width: 1.0,
          ),
          boxShadow: [
            BoxShadow(
            ...
            BoxShadow(
              color: payment.statusColor.withValues(alpha: isDark ? 0.04 : 0.02),
              blurRadius: 12,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  // Left side: Info (Amount, due date)
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Icon(Icons.payment_rounded, size: 13, color: Colors.white),
                                  SizedBox(width: 4),
                                  Text(
                                    'Collect',
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            ...
            BoxShadow(
              color: AppColors.error.withValues(alpha: isDark ? 0.04 : 0.02),
              blurRadius: 12,
              offset: const Offset(0, 4),
            ),
          ],
