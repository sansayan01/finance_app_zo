...
class PendingOperationsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PendingOperationsPage> createState() =>
      _PendingOperationsPageState();
}
...
class _PendingOperationsPageState extends ConsumerState<PendingOperationsPage> {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(syncStatus.isSyncing ? 'Syncing' : 'Sync',
                style: TextStyle(
  ...
  Widget _buildSummaryCard(
      SyncUIState syncStatus, ThemeData theme, bool isDark) {
    return Container(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _buildStatCol('Pending', syncStatus.pending.toString(),
                  Icons.pending_actions_rounded),
              _buildStatCol('Synced', syncStatus.success.toString(),
                  Icons.check_circle_rounded),
              _buildStatCol('Failed', syncStatus.failed.toString(),
          ...
          if (syncStatus.lastSync != null) ...[
            ...
            Container(
              ...
              child: Text('Last sync: ${_formatTime(syncStatus.lastSync!)}',
                  style: TextStyle(
  ...
  Widget _buildTableGroup(String table, List<dynamic> ops, ThemeData theme,
      bool isDark, int groupIndex) {
  ...
  Widget _buildOperationItem(
      dynamic op, ThemeData theme, bool isDark, int index) {
        ...
        children: [
          ...
          if (attempts > 0)
            Container(
              ...
              decoration: BoxDecoration(
                color: (attempts >= 3 ? AppColors.error : AppColors.warning)
              ...
              child: Text('$attempts',
                  style: TextStyle(
                      color:
                          attempts >= 3 ? AppColors.error : AppColors.warning,
                      fontSize: 10,
  ...
  void _removeOperation(String? id) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            const Text('This will discard the pending operation permanently.'),
        actions: [
          TextButton(
