...
class CustomerProfileRepository {
  ...
  Future<bool> updateMemberProfile(
    ...
    try {
      // Server-side RPC performs the members + profiles updates atomically
      // and filters to allowed fields. Pass the raw payload through.
      await _client.rpc('update_member_profile', params: {
