...
class _DailySummaryPageState extends ConsumerState<DailySummaryPage> {
  ...
  Widget _buildContent(String staffId, ThemeData theme, bool isDark) {
    final summaryAsync = ref
        .watch(dailySummaryProvider((staffId: staffId, date: _selectedDate)));
  ...
  Widget _buildSummaryCards(
      Map<String, dynamic> summary, ThemeData theme, bool isDark) {
        ...
        child: Column(
          children: [
            ...
            _buildCollectionsList(
                summary['recent_collections'] as List?, theme, isDark),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(isToday ? Icons.today_rounded : Icons.history_rounded,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(isToday ? 'Today\'s Summary' : 'Summary Report',
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                  child: _buildMetric(
                      theme,
                      'Target',
                      _currencyFormat.format(targetAmount),
                      Icons.flag_rounded,
                      AppColors.primary)),
            ],
          ),
          ...
          Align(
              ...
              child: Text('${(progress * 100).toStringAsFixed(1)}% achieved',
  ...
  Widget _buildPaymentModeBreakdown(
    ...
    return _buildSection(
      ...
      child: Column(
        children: [
          _buildModeRow(theme, 'Cash', cash, cashPct, AppColors.success,
              Icons.payments_rounded, isDark),
          const SizedBox(height: 12),
          _buildModeRow(theme, 'Digital', digital, digitalPct, AppColors.info,
  ...
  Widget _buildModeRow(ThemeData theme, String label, double amount, double pct,
  ...
  Widget _buildVisitSummary(
    ...
    final successRate = totalVisits > 0
        ? (successfulVisits / totalVisits * 100).toStringAsFixed(0)
        : '0';
    ...
    return _buildSection(
      ...
      child: Row(
        children: [
          Expanded(
              child: _buildVisitMetric(theme, totalVisits.toString(), 'Total',
                  Icons.place_rounded, AppColors.primary)),
          Container(
              width: 1,
              height: 50,
              color: theme.dividerColor.withValues(alpha: 0.2)),
          Expanded(
              child: _buildVisitMetric(theme, successfulVisits.toString(),
          ...
          Container(
              ...
              color: theme.dividerColor.withValues(alpha: 0.2)),
          Expanded(
              child: _buildVisitMetric(theme, '$successRate%', 'Success',
  ...
  Widget _buildPerformanceMetrics(
    ...
    return _buildSection(
      ...
      child: Column(
        children: [
          _metaRow(theme, Icons.receipt_long_rounded, 'Collections Made',
              collectionCount.toString(), null),
          const Divider(height: 20),
          _metaRow(theme, Icons.local_fire_department_rounded, 'Current Streak',
              '$streakDays days', Colors.orangeAccent),
        ],
      ),
    );
  }

  Widget _metaRow(ThemeData theme, IconData icon, String label, String value,
      Color? highlight) {
    return Row(
      children: [
        Container(
          padding: const EdgeInsets.all(8),
          decoration: BoxDecoration(
              color: (highlight ?? AppColors.primary).withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(10)),
        ...
        Text(value,
            style: theme.textTheme.titleSmall
                ?.copyWith(fontWeight: FontWeight.w800, color: highlight)),
      ],
    );
  }

  Widget _buildCollectionsList(
      List? collections, ThemeData theme, bool isDark) {
    ...
    return _buildSection(
      ...
      trailing: TextButton(
          onPressed: () => context.push('/staff/history'),
          ...
          return Padding(
            ...
            child: Row(
              children: [
                ...
                Text(_currencyFormat.format(item['amount_collected'] ?? 0),
