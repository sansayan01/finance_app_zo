                ...
                child: Column(
                    ...
                    children: [
                      Row(
                          ...
                          children: [
                            D.header('Audit Logs', 'Track all system changes',
                                isDark),
                            IconButton(
                              ...
                              style: IconButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius:
                                          BorderRadius.circular(D.radius),
                                      side: BorderSide(
              ...
              data: (l) => SliverPadding(
                ...
                sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                        (_, i) => _logCard(l[i], isDark, cardBg),
                        childCount: l.length)),
              ),
  ...
  Widget _logCard(dynamic l, bool isDark, Color cardBg) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border:
              Border.all(color: D.borderColor(isDark).withValues(alpha: 0.6))),
      child: Material(
                ...
                child: Column(
                  ...
                  Row(children: [
                    Container(
                        ...
                        child: Text(l.action.toUpperCase(),
                            style: TextStyle(
                                fontSize: 9,
                  ...
                  Text(DateFormat('MMM d, y • h:mm a').format(l.createdAt),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
            ...
            children: [
              _detailLine(
                  'Entity', '${l.entityType} (${l.entityId ?? 'N/A'})', isDark),
              _detailLine('Action', l.action, isDark),
              _detailLine('User', l.userId ?? 'System', isDark),
              _detailLine('Organization', l.orgId ?? 'N/A', isDark),
              _detailLine('Date',
                  DateFormat('MMM d, y • h:mm a').format(l.createdAt), isDark),
              if (l.oldValues != null && (l.oldValues as Map).isNotEmpty) ...[
                const SizedBox(height: 8),
                Text('Old Values:', style: D.labelStyle(isDark)),
                Text('${l.oldValues}', style: D.valueStyle(isDark))
              ],
              if (l.newValues != null && (l.newValues as Map).isNotEmpty) ...[
                const SizedBox(height: 8),
                Text('New Values:', style: D.labelStyle(isDark)),
                Text('${l.newValues}', style: D.valueStyle(isDark))
              ],
            ]),
        actions: [
          TextButton(
