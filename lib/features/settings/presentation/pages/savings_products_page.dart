...
class SavingsProductsPage extends ConsumerWidget {
  const SavingsProductsPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Savings Products'),
        leading: IconButton(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Create Savings Product',
                  style: TextStyle(fontWeight: FontWeight.bold)),
