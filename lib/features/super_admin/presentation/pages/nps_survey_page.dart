...
class NPSSurveyPage extends ConsumerWidget {
            ...
            SliverPadding(
                ...
                sliver: SliverToBoxAdapter(
                    child: Column(
                        ...
                        children: [
                      D.header('NPS Survey', 'Net Promoter Score management',
                          isDark),
                      const SizedBox(height: 24),
                      Row(children: [
                        _npsCard(context, 'Score', '72', 'Excellent',
                            Colors.green, cardBg),
                        const SizedBox(width: 12),
                        _npsCard(context, 'Promoters', '45%', '9-10 rating',
                            Colors.green, cardBg),
                        const SizedBox(width: 12),
                        _npsCard(context, 'Detractors', '12%', '0-6 rating',
                            Colors.red, cardBg),
                      ]),
                      const SizedBox(height: 24),
                      D.sectionTitle(
                          'Recent Responses', Icons.feedback, isDark),
                      const SizedBox(height: 14),
                      _response(context, 'ABC Finance', 9,
                          'Great platform! Very intuitive.', '2h ago', cardBg),
                      _response(context, 'XYZ Credit', 6,
                          'Need better reporting tools.', '5h ago', cardBg),
                      _response(context, 'LMN Corp', 10,
                          'Excellent support team!', '1d ago', cardBg),
                      const SizedBox(height: 24),
  ...
  Widget _npsCard(BuildContext ctx, String label, String value, String sub,
  ...
  Widget _response(BuildContext ctx, String org, int score, String comment,
      String time, Color cardBg) {
    final isDark = Theme.of(ctx).brightness == Brightness.dark;
    return Container(
