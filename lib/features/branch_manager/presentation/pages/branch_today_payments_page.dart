                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSection('Payment Type', Wrap(
                        ...
                        children: [
                          FilterChip(label: const Text('Both'), selected: filters.paymentTypeFilter == null, onSelected: (_) => notifier.setPaymentType(null), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                          FilterChip(label: const Text('EMI'), selected: filters.paymentTypeFilter == PaymentType.emi, onSelected: (_) => notifier.setPaymentType(PaymentType.emi), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                          FilterChip(label: const Text('Savings'), selected: filters.paymentTypeFilter == PaymentType.savings, onSelected: (_) => notifier.setPaymentType(PaymentType.savings), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                        ],
                      )),
                      _buildSection('Status', Wrap(
                        spacing: 8, runSpacing: 8,
                        children: [
                          FilterChip(label: const Text('Pending'), selected: filters.statusFilters.contains(PaymentStatus.pending), onSelected: (_) => notifier.toggleStatusFilter(PaymentStatus.pending), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                          FilterChip(label: const Text('Overdue'), selected: filters.statusFilters.contains(PaymentStatus.overdue), onSelected: (_) => notifier.toggleStatusFilter(PaymentStatus.overdue), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                          FilterChip(label: const Text('Collected'), selected: filters.statusFilters.contains(PaymentStatus.collected), onSelected: (_) => notifier.toggleStatusFilter(PaymentStatus.collected), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                        ],
                      )),
                      ...
                      _buildSection('Payment Mode', Wrap(
                        ...
                        children: [for (final mode in ['Cash', 'UPI', 'Bank Transfer', 'Cheque'])
                          FilterChip(label: Text(mode), selected: filters.paymentModeFilters.contains(mode.toLowerCase()), onSelected: (_) => notifier.togglePaymentMode(mode.toLowerCase()), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                        ],
                      )),
                      _buildSection('Overdue Days', Wrap(
                        spacing: 8, runSpacing: 8,
                        children: OverdueBucket.values.map((b) => FilterChip(label: Text(b.label), selected: filters.overdueDayFilters.contains(b), onSelected: (_) => notifier.toggleOverdueBucket(b), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary)).toList(),
                      )),
                      _buildSection('Agent', agentsAsync.when(
                        loading: () => const LinearProgressIndicator(),
                        error: (e, _) => Text('Error: $e'),
                        data: (agents) => Wrap(
                          spacing: 8, runSpacing: 8,
                          children: [
                            FilterChip(label: const Text('All Agents'), selected: filters.agentId == null, onSelected: (_) => notifier.setAgent(null), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary),
                            ...agents.map((a) => FilterChip(label: Text(a['name']!), selected: filters.agentId == a['id'], onSelected: (_) => notifier.setAgent(a['id']), selectedColor: AppColors.primary.withValues(alpha: 0.15), checkmarkColor: AppColors.primary)),
                          ],
                        ),
                      )),
                    ],
          ...
          if (!_showSearch) ...[
            ...
            IconButton(
              icon: Icon(
                ...
                color: filters.hasActiveFilters ? AppColors.primary : null,
              ),
