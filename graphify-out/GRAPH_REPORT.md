# Graph Report - finance_app_zo  (2026-07-13)

## Corpus Check
- 900 files · ~1,124,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14613 nodes · 20511 edges · 728 communities (610 shown, 118 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df5d8511`
...
- `Use Partial Indexes for Filtered Queries` --conceptually_related_to--> `Add Indexes on WHERE and JOIN Columns`  [EXTRACTED]
  .agents/skills/supabase-postgres-best-practices/references/query-partial-indexes.md → .claude/skills/supabase-postgres-best-practices/references/query-missing-indexes.md
...
- **Shared HUD Navigation Shell Across Portals** — claude_md_design_hierarchy, claude_md_hud_navigation, docs_session_log_super_admin_portal, claude_md_microflow_pro [INFERRED 0.85]
...
## Communities (728 total, 118 thin omitted)

### Community 0 - "SMS & Admin Core"
Cohesion: 0.10
Nodes (20): ../../data/providers/notification_providers.dart, main, main, package:flutter_riverpod/flutter_riverpod.dart, package:integration_test/integration_test.dart, package:microflow_pro/app.dart, package:microflow_pro/core/providers/storage_providers.dart, package:shared_preferences/shared_preferences.dart (+12 more)

### Community 1 - "Payments & Collection"
Cohesion: 0.02
Nodes (146): bulk_import_members_page.dart, ConsumerWidget, InheritedWidget, ../../../invitations/data/models/org_invitation_model.dart, ../../../invitations/data/providers/invitation_providers.dart, org_chart_page.dart, _handleAction, _RowActions (+138 more)
...
Cohesion: 0.02
Nodes (98): Duration get, action, activeLoanCount, activeOrganizations, activeUsers, activityLogs, address, affectedServices (+90 more)
...
Cohesion: 0.03
Nodes (90): branch_manager_providers.dart, branchStatsProvider, ../../../../core/widgets/sparkline_chart.dart, ../../../home/presentation/widgets/live_agents_map_card.dart, ../../../loans/data/models/loan_model.dart, BranchAnalyticsPage, _BranchAnalyticsPageState, build (+82 more)
...
Cohesion: 0.02
Nodes (138): ../../data/models/today_payment_model.dart, ../../data/providers/payment_providers.dart, ../../data/services/auto_collection_service.dart, ../../data/utils/payment_export.dart, _AddUserFab, _AuroraBackdrop, _Avatar, _ChoiceChip (+130 more)
...
Cohesion: 0.02
Nodes (85): ?, ../../data/providers/integrations_providers.dart, ../../data/providers/payment_gateway_providers.dart, bg, build, _buildCommunicationsTab, _buildEmailCard, _buildGatewayConfigCard (+77 more)
...
Cohesion: 0.02
Nodes (81): ../../../customer_portal/data/providers/customer_savings_providers.dart, ../../data/services/savings_statement_csv_service.dart, ../../data/services/savings_statement_excel_service.dart, ../../data/services/savings_statement_models.dart, ../../data/services/savings_statement_pdf_service.dart, ../../../../features/transactions/data/models/transaction_model.dart, amount, _applyTransactionEdit (+73 more)

### Community 17 - "Branch Collections"
Cohesion: 0.03
Nodes (83): ../../data/services/loan_statement_csv_service.dart, ../../data/services/loan_statement_excel_service.dart, ../../data/services/qr_png.dart, _saveLoan, _addNote, _archiveStatement, _buildActionButton, _buildAmbientBackground (+75 more)

### Community 18 - "Customer Profile & KYC"
Cohesion: 0.05
Nodes (85): AutomaticKeepAliveClientMixin, MaterialPageRoute, _navigateToActivity, _navigateToBranches, _navigateToTeamMembers, _save, _uploadLogo, _BranchTodayPaymentsPageState (+77 more)
...
Cohesion: 0.04
Nodes (54): ../../../branch_manager/data/providers/branch_payment_providers.dart, emi_payment_selector.dart, EMIScheduleModel? get, dateTime, ../../../payments/data/providers/upi_providers.dart, ../../../payments/data/services/upi_service.dart, ../../../savings/data/models/savings_installment_model.dart, ../../../savings/presentation/widgets/savings_payment_selector.dart (+46 more)
...
Cohesion: 0.06
Nodes (50): ../../data/providers/duty_providers.dart, ../../data/providers/live_tracking_providers.dart, _maybePromptTracking, _StaffHomePageState, build, _StaffMapPageState, activeDutySessionProvider, onDutyProvider (+42 more)
...
Cohesion: 0.04
Nodes (48): _activeFilter, _applyFilters, _AuroraBackdrop, _buildEmptyState, _buildFilterChips, _buildHero, _buildInitialAvatar, _buildSearchBar (+40 more)
...
Cohesion: 0.06
Nodes (38): Activity, Array, Boolean, ConcurrentHashMap, CoroutineWorker, FlutterFragmentActivity, Int, IntArray (+30 more)
...
Cohesion: 0.04
Nodes (53): ../../../../core/utils/error_formatter.dart, ../../../../features/super_admin/data/models/super_admin_models.dart, ../../../../features/super_admin/data/providers/super_admin_providers.dart, OrgDetailData, _actColor, _actIcon, AdminOrgDetailPage, _AdminOrgDetailPageState (+45 more)
...
Cohesion: 0.04
Nodes (49): _addressCtrl, autofillHints, children, _cityCtrl, client, controller, createState, _currencies (+41 more)
...
Cohesion: 0.04
Nodes (55): build, agentId, allPayments, _applyAdvancedFilters, autoRefresh, autoRefreshTimerProvider, branchId, client (+47 more)
...
Cohesion: 0.06
Nodes (35): LoanModel, _ActiveLoansSection, _activityDisplay, build, _buildActionCard, _buildActiveLoansSection, _buildDailyTargetCompact, _buildDashboardItem (+27 more)
...
Cohesion: 0.03
Nodes (90): ../../data/models/customer_profile_model.dart, ../../data/providers/customer_biometric_providers.dart, ../../data/providers/customer_connection_provider.dart, ../../data/providers/customer_member_provider.dart, ../../data/providers/customer_notification_preferences_provider.dart, ../../data/providers/customer_notifications_providers.dart, ../../data/providers/customer_profile_providers.dart, ../../data/providers/customer_realtime_providers.dart (+82 more)
...
Cohesion: 0.06
Nodes (33): ../../../auth/presentation/providers/auth_provider.dart, ../../data/providers/setup_provider.dart, _branchCodeController, _branchFormKey, _branchNameController, build, _buildBranchStep, _buildHeader (+25 more)
...
Cohesion: 0.10
Nodes (24): ../../../../core/providers/branding_provider.dart, core/services/auto_update_service.dart, ../../../../core/services/push_notification_provider.dart, core/theme/app_theme.dart, core/widgets/update_wrapper.dart, features/settings/data/providers/brand_provider.dart, build, createState (+16 more)
...
Cohesion: 0.09
Nodes (24): ../../../branches/data/providers/branch_providers.dart, ../../../branches/models/branch_model.dart, ../../data/csv_utils.dart, _branchId, build, _buildBranchPicker, _buildErrorsCard, _buildPickerCard (+16 more)
...
Cohesion: 0.12
Nodes (17): Point, Create(), Destroy(), GetHandle(), GetThisFromHandle(), OnCreate(), OnDestroy(), Scale() (+9 more)
...
Cohesion: 0.05
Nodes (39): Alignment, ../../../../core/utils/file_download.dart, ../../data/services/portfolio_savings_statement_pdf_service.dart, ../../../loans/presentation/widgets/portfolio_statement_options_sheet.dart, ../../../loans/presentation/widgets/statement_generation_overlay.dart, _MonthHeaderDelegate, _SliverHeaderDelegate, _activeFilter (+31 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (36): core/config/env_config.dart, ../../../../core/utils/url_utils.dart, dart:convert, ../models/chat_message.dart, package:http/http.dart, ChatbotRepository, streamChatResponse, _supabase (+28 more)
...
Cohesion: 0.11
Nodes (18): ../../data/providers/collection_providers.dart, build, _buildCircularProgress, _buildEmptyTarget, _buildHistoryRow, _buildMonthlyStat, _buildPeriodSelector, _buildStatChip (+10 more)
...
Cohesion: 0.08
Nodes (31): ../../../auth/data/models/user_model.dart, branchStaffProvider, ../../../chatbot/presentation/providers/chat_config_provider.dart, ../../../../core/services/haptic_service.dart, ../../../../core/theme/design_system.dart, ../../../../core/theme/theme_provider.dart, ../../../../core/widgets/powered_by_badge.dart, ../../data/providers/brand_provider.dart (+23 more)
...
Cohesion: 0.04
Nodes (47): ../../../../core/providers/org_provider.dart, customer_member_provider.dart, ../models/customer_profile_model.dart, client, createFeedbackProvider, customerFeedbackRepositoryProvider, customerId, getFeedbacks (+39 more)
...
Cohesion: 0.12
Nodes (15): branchAsync, client, currentStaffBranchIdProvider, orgId, profile, staffProfileId, staffTimelineProvider, checkIn (+7 more)
...
Cohesion: 0.06
Nodes (28): ../models/customer_feedback_model.dart, ../models/payment_order_model.dart, isAuthenticatedProvider, supabaseUserProvider, ActivityLogRepository, _client, fetchLogs, log (+20 more)
...
Cohesion: 0.06
Nodes (36): ../models/savings_model.dart, Object?, allSavingsProvider, client, copyWith, empty, error, generate (+28 more)
...
Cohesion: 0.07
Nodes (28): customer_home_providers.dart, customer_notifications_providers.dart, customer_profile_providers.dart, customer_savings_providers.dart, customer_support_providers.dart, client, orgId, package:microflow_pro/providers/supabase_provider.dart (+20 more)
...
Cohesion: 0.05
Nodes (41): dart:io, ../../../loans/data/models/emi_schedule_model.dart, ../../../loans/data/services/loan_statement_pdf_service.dart, package:flutter_image_compress/flutter_image_compress.dart, package:microflow_pro/features/auth/presentation/providers/auth_provider.dart, package:microflow_pro/features/payments/data/models/today_payment_model.dart, package:microflow_pro/features/payments/data/providers/payment_providers.dart, package:path_provider/path_provider.dart (+33 more)
...
Cohesion: 0.06
Nodes (34): ../models/savings_installment_model.dart, _calculateMaturityDate, calculateMigrationOverdue, _calculateTotalInstallments, _client, closeSavingPlan, _computeCollectionDate, _computeNextDueDate (+26 more)
...
Cohesion: 0.07
Nodes (36): MapController, package:flutter_map/flutter_map.dart, _AgentDetailSheet, _AgentDetailSheetState, build, _buildMap, _fitMapToAgents, _initRealtime (+28 more)
...
Cohesion: 0.06
Nodes (30): repository, staffWalletProvider, ../models/wallet_model.dart, dailySummaryProvider, ensureTodayTarget, getActiveVisit, getCurrentActivity, getDailySummary (+22 more)
...
Cohesion: 0.03
Nodes (87): ConsumerState, ../../../../core/services/location_service.dart, ../../../../core/widgets/smokey_background.dart, _BreakLoggingPageState, _checkCurrentBreakStatus, _handleBreakAction, _amountController, build (+79 more)
...
Cohesion: 0.09
Nodes (17): main, main, package:flutter_test/flutter_test.dart, package:microflow_pro/core/utils/formatters.dart, package:microflow_pro/core/widgets/glass_button.dart, package:microflow_pro/core/widgets/shimmer_loading.dart, package:microflow_pro/core/widgets/status_badge.dart, package:microflow_pro/features/auth/data/models/user_model.dart (+9 more)
...
Cohesion: 0.07
Nodes (27): ActivityLogRepository, ../../data/repositories/savings_repository.dart, ../features/auth/presentation/providers/auth_provider.dart, provider, _activeFilter, build, _buildApprovalCard, _buildApprovalList (+19 more)
...
Cohesion: 0.08
Nodes (30): _buildQuickActions, _buildStaffSnapshot, _buildQuickActions, _buildDisbursementVsCollection, _buildPortfolioTrend, build, _HeroCard, _SavingsSection (+22 more)

### Community 213 - "Community 213"
Cohesion: 0.10
Nodes (26): _achievementCard, _achievements, build, createState, dispose, GamificationDashboard, _GamificationDashboardState, initState (+18 more)
...
Cohesion: 0.07
Nodes (27): CollectionModel, ../models/collection_model.dart, main, package:microflow_pro/core/constants/enums.dart, package:microflow_pro/features/loans/data/models/loan_model.dart, _client, CollectionRepository, deleteCollection (+19 more)
...
Cohesion: 0.03
Nodes (64): ../../../../core/constants/app_spacing.dart, ../../../../core/widgets/status_badge.dart, ../../data/models/customer_emi_model.dart, ../../data/models/customer_loan_model.dart, ../../data/models/customer_notification_model.dart, ../../data/models/customer_savings_model.dart, ../../data/models/customer_transaction_model.dart, CustomerLoanModel (+56 more)
...
Cohesion: 0.18
Nodes (12): ../../data/providers/staff_providers.dart, _buildTargetHistory, premium_helpers.dart, recentActivitiesProvider, weeklyTrendProvider, ActivityFeedTimeline, build, _buildActivityRow (+4 more)
...
Cohesion: 0.05
Nodes (40): customer_loan_breakdown_chart.dart, customer_payment_trend_chart.dart, customer_savings_growth_chart.dart, package:fl_chart/fl_chart.dart, animation, build, child, createState (+32 more)
...
Cohesion: 0.04
Nodes (60): ConsumerStatefulWidget, _CountUp, BranchLoansPage, _BranchLoansPageState, BranchMembersPage, _BranchMembersPageState, BranchSavingsPage, _BranchSavingsPageState (+52 more)
...
Cohesion: 0.06
Nodes (31): ../models/staff_profile_model.dart, ../models/streak_model.dart, ../models/target_model.dart, _client, completeVisit, endBreak, ensureTodayTarget, getActiveVisit (+23 more)

### Community 256 - "Community 256"
Cohesion: 0.08
Nodes (25): _buildBranchTargetsCard, _showEditTargetsDialog, authState, branchCollectionsProvider, branchDailySummaryProvider, branchId, branchManagerDashboardProvider, branchManagerRepositoryProvider (+17 more)
...
Cohesion: 0.05
Nodes (37): ../../../../core/constants/enums.dart, file_download_stub.dart, package:flutter/foundation.dart, _client, detectAndFreezeSkippedEMIs, _extendLoanTenure, freezeSingleEMI, generateSchedule (+29 more)
...
Cohesion: 0.02
Nodes (152): ActivityLogModel, ../core/constants/app_colors.dart, ../../../../core/utils/formatters.dart, ../../../../core/widgets/aurora_background.dart, ../../../../core/widgets/glass_button.dart, ../../../../core/widgets/glass_card.dart, ../../../../core/widgets/shimmer_card.dart, ../../data/constants/legal_content.dart (+144 more)
...
Cohesion: 0.17
Nodes (11): debugInfo, EnvConfig, envf, fromEnvironment, isLocalEnvironment, isValidConfig, _prodAnonKey, _prodUrl (+3 more)
...
Cohesion: 0.24
Nodes (10): build, build, _buildAdminAuditTimeline, _buildAdminNotes, UserDetailsPage, adminNotesProvider, userAuditLogsProvider, userLoansProvider (+2 more)
...
Cohesion: 0.13
Nodes (14): Anti-Patterns, CLAUDE.md — Project Instructions, Design DNA, Execution Style, graphify, How I Work With Sayan (bro, not agent/user), Implementation Preferences, Latest Update (rolling — replaced after every conversation) (+6 more)
...
Cohesion: 0.08
Nodes (24): state, AuthShell, _AuthShellState, ../services/haptic_service.dart, activeIcon, build, _buildHUDItem, child (+16 more)
...
Cohesion: 0.05
Nodes (39): createdAt, CustomerFeedbackModel, fromJson, id, isInReview, isNew, isResolved, message (+31 more)
...
Cohesion: 0.04
Nodes (51): kBottomNavBarHeight, kBottomNavInsets, kBottomNavSafeArea, kFabSafeAreaPadding, ../../../../core/services/app_icon_service.dart, ../core/widgets/hud_navigation.dart, dart:ui, EdgeInsets (+43 more)
...
Cohesion: 0.15
Nodes (17): 1. Concrete Transformation Patterns, 2. Error-First Structure, 3. Quantified Impact, 4. Self-Contained Examples, 5. Semantic Naming, Code Example Standards, Comments, Impact Level Guidelines (+9 more)
...
Cohesion: 0.15
Nodes (15): BroadcastReceiver, Context, prefs(), readStoredReminderTime(), SmsBootReceiver, writeStoredReminderTime(), ../providers/storage_providers.dart, SharedPreferences (+7 more)
...
Cohesion: 0.06
Nodes (30): Color, EdgeInsetsGeometry?, PreferredSizeWidget, Size get, Widget, blurSigma, borderRadius, build (+22 more)
...
Cohesion: 0.04
Nodes (43): content, icon, kDataProcessingSections, kLegalLastUpdated, kPrivacyPolicySections, kRefundPolicySections, kTermsOfServiceSections, LegalSection (+35 more)
...
Cohesion: 0.19
Nodes (14): Executive Admin Portal — Deep Audit (14 bugs), Agents Documentation, Fix: Today's Payment 'Done' Tab Logic, Portal Development Plan — 3 New Portals, 5 Portals (incl. Admin & Customer), Collections — GPS-verified Field Collections, Customer Self-Service Portal, MicroFlow Pro — Micro-Finance Domain (+6 more)
...
Cohesion: 0.19
Nodes (9): Use Advisory Locks for Application-Level Locking, Prevent Deadlocks with Consistent Lock Ordering, Keep Transactions Short to Reduce Lock Contention, Use SKIP LOCKED for Non-Blocking Queue Processing, Section: Concurrency & Locking (lock), Use Advisory Locks for Application-Level Locking, Prevent Deadlocks with Consistent Lock Ordering, Keep Transactions Short to Reduce Lock Contention (+1 more)
...
Cohesion: 0.03
Nodes (90): _ActionButton, AnimationController, _AuroraBackground, BorderRadius?, _CircleIconButton, Duration, GradientTransform, _CountUp (+82 more)

### Community 369 - "Community 369"
Cohesion: 0.10
Nodes (19): _loadEmailConfig, _loadWhatsAppConfig, _saveEmail, _saveWhatsApp, _sendTestEmail, _sendWaTest, client, emailCommunicationsProvider (+11 more)

### Community 370 - "Community 370"
Cohesion: 0.18
Nodes (7): Select Optimal Primary Key Strategy, Select Optimal Primary Key Strategy, Add Constraints Safely in Migrations, Index Foreign Key Columns, Select Optimal Primary Key Strategy, Add Constraints Safely in Migrations, Index Foreign Key Columns
...
Cohesion: 0.08
Nodes (21): dart:html, outbox, client, _fallbackCustomerLocations, _getLastVisitLocation, loans, orgId, profile (+13 more)
...
Cohesion: 0.14
Nodes (17): branchMembersProvider, build, _buildMissionCard, build, _buildFilterChips, _onRefresh, StaffTimelinePage, _StaffTimelinePageState (+9 more)
...
Cohesion: 0.38
Nodes (6): ../../data/providers/gamification_providers.dart, _leaderboard, staffLeaderboardProvider, Route /staff/gamification, build, LeaderboardSnapshot
...
Cohesion: 0.44
Nodes (10): HWND, LPARAM, LRESULT, MessageHandler(), EnableFullDpiSupportIfAvailable(), MessageHandler(), UpdateTheme(), WndProc() (+2 more)
...
Cohesion: 0.22
Nodes (6): Add Constraints Safely in Migrations, Index Foreign Key Columns, Use Lowercase Identifiers for Compatibility, Add Constraints Safely in Migrations, Index Foreign Key Columns, Use Lowercase Identifiers for Compatibility
...
Cohesion: 0.07
Nodes (24): ../models/customer_notification_model.dart, ../models/customer_ticket_model.dart, package:supabase_flutter/supabase_flutter.dart, _client, CustomerNotificationsRepository, getNotifications, getUnreadCount, markAllAsRead (+16 more)

### Community 437 - "Community 437"
Cohesion: 0.11
Nodes (19): GoRouter, _buildAppBar, unreadNotificationCountProvider, Route /customer/payments, Route /notifications, Route /staff, Route /staff/notifications, Route /staff/visits (+11 more)
...
Cohesion: 0.22
Nodes (8): 2. Supabase Setup, 3. main.dart Updates, 4. GoRouter Updates, 5. Run Flutter Commands, 6. Test Checklist, 9. Architecture Notes, Need Help?, Staff Portal Setup Checklist
...
Cohesion: 0.29
Nodes (6): _client, EmailSettingsService, getCommunications, _orgId, saveCommunications, sendTestEmail
...
Cohesion: 0.50
Nodes (3): package:microflow_pro/core/services/sms_service.dart, main, svc
...
Cohesion: 0.06
Nodes (32): Animation, amount, _animController, build, _buildChart, _buildEmptyState, createState, CustomerPaymentTrendChart (+24 more)
...
## Knowledge Gaps
- **10299 isolated node(s):** `fs`, `content`, `normalizedContent`, `supabase`, `@mimo-ai/plugin` (+10294 more)
...
- **Why does `FormState` connect `Community 109` to `Community 193`, `Supabase Best Practices`, `Community 102`, `Community 231`, `Staff Collection Sheet`, `Community 267`, `Community 75`, `Branch Scoped State`, `Community 82`, `Community 180`, `Staff Payments & Export`, `Branch Users List`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `map` connect `Community 127` to `Branch Users & Tabs`, `Staff Today Payments`, `User Details & Audit`, `Staff Dashboard Core`, `Community 139`, `Community 142`, `App Update & Versioning`, `Community 151`, `Community 157`, `Community 158`, `Community 160`, `Branch Manager Dashboard`, `Community 294`, `Email & Marketing`, `Permission & Access`, `Community 182`, `Customer Feedback System`, `Collection History`, `Community 71`, `Community 330`, `Community 75`, `Community 82`, `Community 247`, `Community 222`, `Community 100`, `Community 238`, `Community 239`, `Community 113`, `Community 246`, `Community 119`, `Community 124`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `GetCommandLineArguments()` connect `Community 549` to `Email & Marketing`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `fs`, `content`, `normalizedContent` to the rest of the system?**
  _10309 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Payments & Collection` be split into smaller, more focused modules?**
  _Cohesion score 0.01654715940430226 - nodes in this community are weakly interconnected._
