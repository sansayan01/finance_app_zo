...
class _CustomerSavingsDetailPageState
  ...
  /// Indian-style currency formatting (e.g. ₹12,34,567 / ₹1.23 L / ₹1.05 Cr).
      ...
      children: [
        ...
        Expanded(
          child: _ActionButton(
            ...
            onTap: () => _comingSoon('Download Statement'),
          ),
        ),
      ],
    );
