...
class _AnnouncementsPageState extends ConsumerState<AnnouncementsPage> {
                ...
                child: Column(
                    ...
                    children: [
                      Row(
                          ...
                          children: [
                            D.header('Announcements',
                                'Broadcast to platform users', isDark),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
              child: Column(
                ...
                Text(DateFormat('MMM d, y').format(a.createdAt),
                    style: D.subtitleStyle(isDark)),
              ])),
          if (!a.isActive)
            Container(
        ...
        Row(children: [
          Container(
              ...
              child: Text(a.type,
                  style: TextStyle(
                      fontSize: 10, fontWeight: FontWeight.w500, color: tc))),
          const Spacer(),
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              ...
              PopupMenuItem(
                  ...
                  child: ListTile(
                      leading: Icon(
                          a.isActive ? Icons.visibility_off : Icons.visibility,
                          size: 18),
                      title: Text(a.isActive ? 'Deactivate' : 'Activate'),
                      dense: true)),
              const PopupMenuItem(
                  value: 'delete',
                  child: ListTile(
          ...
          builder: (ctx, setS) => AlertDialog(
                ...
                content: SingleChildScrollView(
                  ...
                  DropdownButtonFormField<String>(
                      ...
                      items: ['info', 'warning', 'critical', 'maintenance']
                  ...
                  DropdownButtonFormField<String>(
                      ...
                      items: ['all', 'admins', 'managers', 'agents']
  ...
  void _toggle(String id, bool v) async {
    await ref
        .read(superAdminActionsProvider.notifier)
        .updateAnnouncement(id: id, isActive: v);
  }
