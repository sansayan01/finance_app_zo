...
- [x] 1. Bootstrap the standalone Next.js project
  - [x] 1.1 Scaffold `marketing_site/` as a Next.js 14+ App Router TypeScript project
  ...
  - [x] 1.2 Install runtime and devtool dependencies via pnpm
  ...
  - [x] 1.3 Document configuration and create `.env.example` + `README.md`
...
- [x] 2. Brand system, typography, and theming foundation
  - [x] 2.1 Author `app/globals.css` with CSS variables and Tailwind layers
  ...
  - [x] 2.2 Configure `tailwind.config.ts` with brand tokens
    - `darkMode: 'class'`
  ...
  - [x] 2.3 Wire `next/font` for Outfit (display) and Plus Jakarta Sans (body)
  ...
  - [x] 2.4 Implement ThemeProvider, ThemeToggle, and SkipLink primitives
...
- [x] 3. Site config and layout chrome
  - [x] 3.1 Create `lib/site-config.ts` source of truth
  ...
  - [x] 3.2 Compose root `app/layout.tsx`
  ...
  - [x] 3.3 Compose `app/(marketing)/layout.tsx`
    - Render `<Nav />`, `<main id="main" tabIndex={-1}>{children}</main>`, `<Footer />`
    - _Requirements: 8.1, 8.7, 10.6, 10.9_

  - [x] 3.4 Implement `components/layout/Nav.tsx` (sticky glass)
  ...
  - [x] 3.5 Implement `components/layout/MobileMenu.tsx` (`'use client'`)
  ...
  - [x] 3.6 Implement `components/layout/Footer.tsx`
...
- [x] 4. UI primitives library
  - [x] 4.1 Build `components/ui/` primitives with `class-variance-authority`
...
- [x] 5. Environment validation and Supabase plumbing
  - [x] 5.1 Implement `lib/env.ts` with zod schemas
  ...
  - [x] 5.4 Author Supabase migration `marketing_leads` table + RLS
...
- [x] 6. Pricing source of truth
  - [x] 6.1 Implement `lib/pricing.ts`
...
- [x] 7. Page section components (server)
  - [x] 7.1 Build `components/sections/Hero.tsx`
  ...
  - [x] 7.9 Build `components/sections/FeatureComparisonTable.tsx`
    - Static `id → tier → boolean|string` matrix rendered as accessible `<table>` with `<th scope>`
    - _Requirements: 4.3_

  - [x] 7.10 Build `components/sections/FaqAccordion.tsx`
    - Six FAQ entries using native `<details>`/`<summary>` for zero-JS interactivity
    - _Requirements: 4.3_

- [x] 8. Marketing routes
  - [x] 8.1 Implement `app/(marketing)/page.tsx` (Landing)
  ...
  - [x] 8.2 Implement `app/(marketing)/features/page.tsx`
  ...
  - [x] 8.3 Implement `app/(marketing)/pricing/page.tsx`
  ...
  - [x] 8.6 Implement branded `app/not-found.tsx`
    - Render brand chrome (Nav, Footer), 404 messaging, links back to `/` and `/blog`
    - _Requirements: 1.9, 1.10_
    - _Properties: P3_

- [x] 9. Contact form and lead capture
  - [x] 9.1 Implement `app/actions/submit-lead.ts` server action
  ...
  - [x] 9.2 Implement `components/forms/ContactForm.tsx` (`'use client'`)
...
- [x] 10. Demo booking flow
  - [x] 10.1 Implement `components/demo/DemoBookingTrigger.tsx` (`'use client'`)
  ...
  - [x] 10.2 Implement `components/demo/DemoModal.tsx` (`'use client'`, default export)
...
- [x] 11. Blog (MDX) pipeline
  - [x] 11.1 Implement `lib/mdx.ts`
  ...
  - [x] 11.2 Implement blog components
  ...
  - [x] 11.3 Seed `content/blog/*.mdx` posts
  ...
  - [x] 11.4 Implement `app/blog/page.tsx` (Blog Index)
  ...
  - [x] 11.5 Implement `app/blog/[slug]/page.tsx`
...
- [x] 12. SEO, sitemap, OG, and middleware
  - [x] 12.1 Implement `components/seo/buildMetadata.ts`
  ...
  - [x] 12.2 Add per-route `metadata` exports
  ...
  - [x] 12.3 Implement `app/sitemap.ts` and `app/robots.ts`
  ...
  - [x] 12.4 Implement `app/opengraph-image.tsx` via `@vercel/og`
  ...
  - [x] 12.5 Implement `middleware.ts` for preview noindex
...
- [x] 13. Vercel deployment configuration
  - [x] 13.1 Author `vercel.json` security headers
  ...
  - [x] 13.2 Document Vercel project setup in `README.md`
...
- [x] 14. Checkpoint — local build, lint, type-check
