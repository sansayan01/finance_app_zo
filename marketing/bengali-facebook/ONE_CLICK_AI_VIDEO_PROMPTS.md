...
> **Fast-Paced 10.0s AI Production Breakthrough (Google Veo 3.1 / Kling 1.5 / Runway / HeyGen):**
> 1. **Zero Speaker Voice Swapping:** Customer dialogue (0-2.5s) is set to `Off-Camera Background Voice`, while camera lip-sync is assigned ONLY to the Money-Lender (2.5s-10.0s).
> 2. **Zero Audio Truncation (Fast 1.8 words/sec Pacing):** Spoken script is strictly capped at **13 Bengali Words**, completing at 9.2 seconds with a 0.8s clean audio buffer.
> 3. **Heavy Negative Prompt Weights:** Includes weighted negative triggers `(bad lip sync:1.5), (incorrect speaker attribution:1.5), (customer speaking with lender voice:1.5)`.

---

## 🎬 Reel 01 Master Copy-Paste Prompt Block (Example)
